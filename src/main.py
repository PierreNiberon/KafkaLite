...
def create_topic(topic_name):
    ...
    topic_path = os.path.join(topics_dir, f"{topic_name}.log")
    metadata_path = os.path.join(topics_dir, f"{topic_name}.meta")
...
if __name__ == "__main__":
    ...
    parser.add_argument('action', choices=['create_topic', 'produce'], help="Action to perform")
    parser.add_argument('topic', help="Name of the topic")
    parser.add_argument('--message', help="Message to produce (required for 'produce')", default=None)
